...
df = pd.read_csv(r"C:\Users\asus\Desktop\data science course notes\Untitled Folder\athlete_events.csv")
df_country = pd.read_csv(r"C:\Users\asus\Desktop\data science course notes\Untitled Folder\country_definitions.csv")

df = preprocessor.preprocess(df,df_country)
